...
public class MsrRegection {
    ...
    public static MsrRegection toModel(MsrRejectionEntity entity){
        MsrRegection model  = new MsrRegection();

        model.setMsr_rejection_id(entity.getMsr_rejection_id());
        model.setMsr_rejection_code(entity.getMsr_rejection_code());
        model.setMsr_type_mask(entity.getMsr_type_mask());
        model.setMsr_rejection_mask_id(entity.getMsr_rejection_mask_id());
        model.setMsr_rejection_sysname(entity.getMsr_rejection_sysname());
        model.setMsr_rejection_name(entity.getMsr_rejection_name());
        model.setMsr_reejection_sname(entity.getMsr_reejection_sname());
        model.setMsr_rejection_desc(entity.getMsr_rejection_desc());
        model.setMsr_rejection_correct(entity.isMsr_rejection_correct());
        model.setMsr_rejection_recommendation_no(entity.getMsr_rejection_recommendation_no());
